...
function App() {
  ...
  return (
    <Router>
      <div>
        <Navbar onAdd={onAdd} showAdd={showAddTask}/>
        <Routes>
        <Route path='/' element={<><Header /></>} />
        <Route path='/tasks' element={<><Tasks tasks={tasks} showAdd={showAddTask} addTask={addTask} onDelete={deleteTask} toggle={toggleReminder}/></>} />
        </Routes>
        <Footer />
      </div>
    </Router>
